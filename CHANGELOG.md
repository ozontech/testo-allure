...
- Fixed failed statuses not showing for `BeforeAll` & `AfterAll` hooks.
...
[1.4.0]: https://github.com/ozontech/testo-allure/compare/v1.3.0...v1.4.0
[1.3.0]: https://github.com/ozontech/testo-allure/compare/v1.2.2...v1.3.0
